...
execute store result score .selectedArmID variables run execute on vehicle run scoreboard players get @s leftArmID
scoreboard players set .mechSide variables 2
